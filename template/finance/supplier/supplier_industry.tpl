        ...
        <div class="publicform fix">
         <form id="formID" method="post" action="[BASE_URL]finance/action.php" target="post_frame">
        	<table width="100%" cellpadding="0" cellspacing="0" border="0" class="sbd1">
                <tr>
                    <td style="font-weight:bold;width:150px">媒体简称</td>
                    <td><input type="text" name="supplier_name" id="supplier_name" class="validate[required,maxSize[255]] text_new" style="width:300px;"/></td>
                </tr>
                 <tr>
                    <td style="font-weight:bold;width:150px">客户行业分类名称</td>
                    <td><input type="text" name="industry_name"  id="industry_name" class="validate[required,maxSize[255]] text_new" style="width:300px;"/></td>
                </tr>
            </table>
            <div class="btn_div"><input type="hidden" name="vcode" value="[VCODE]"/><input type="hidden" name="action" value="supplier_industry"/><input type="submit" value="提 交" class="btn_sub" id="submit" />
			</div>
      		</form>
...
$(document).ready(function() {
	//查询已有的媒体名称
	$("#supplier_name").autocomplete(base_url + "finance/supplier/?o=getSupplierShortName", { width: 300, max: 50 });
