...
$(document).ready(function() {
	...
	$("#dosearch").click(function(){
		location.href = base_url + "finance/supplier/?o=supplierlist&search=" + $("#search").val();
	});
});
...
function cancel(id,recover){
	...
	if(window.confirm("确认" + al + "？")){
		$.ajax({
			   ...
			   url: "do.php",
			   cache:false,
			   data: "action=supplier_cancel&id=" + id + "&recover=" +  recover + "&t=" + Math.random() + "&vcode=" + vcode,
			   dataType:'text',
			   async: false,
		...
		location.href="[BASE_URL]finance/supplier/?o=supplierlist";
	}
}
</script>
</body>
