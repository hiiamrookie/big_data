         ...
         <form id="formID" method="post" action="[BASE_URL]finance/action.php" target="post_frame">
        	<table width="100%" cellpadding="0" cellspacing="0" border="0" class="sbd1">
                ...
                <tr>
                    ...
                    <td><input type="text" name="in_invoice_tax_rate"  id="in_invoice_tax_rate" class="validate[required,custom[number],min[0],max[100]] text_new" value="[ININVOICETAXRATE]"/>&nbsp;%</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
						<div>
                    		...
                    		<input type="button" id="upload" value="上 传" onclick="up_uploadfile(this,'dids',0,0);" class="btn"/><input type="hidden" name="dids" id="dids" size="50" value="[DIDSVALUE]"/>&nbsp;&nbsp;<font color="red">*只能上传 [VALIDATE_TYPE] 类型的文件，且单个文件最多 [VALIDATE_SIZE]M</font>
						</div>
						[DIDS]
					</td>
                </tr>
            </table>
            <div class="btn_div"><input type="hidden" name="id" value="[ID]"/><input type="hidden" name="vcode" value="[VCODE]"/><input type="hidden" name="action" value="supplier_reaudit"/><input type="submit" value="提 交" class="btn_sub" id="submit" />
			</div>
      		</form>
