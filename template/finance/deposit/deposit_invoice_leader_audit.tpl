	...
	<div id="content" class="fix">
    	...
    	<div class="publicform fix">
    		<form id="formID" method="post" action="[BASE_URL]finance/action.php" target="post_frame">
      		...
      		<div>
      			<input type="hidden" name="vcode" id="vcode" value="[VCODE]"/><input type="hidden" name="action" id="action" value="deposit_invoice_leader_confirm"/>
      		</div>
      		</form>
...
$(document).ready(function() {	
	...
	$("#confirm1").click(function(){
		...
		$("#action").val("deposit_invoice_leader_confirm");
		$("#formID").submit();
	});
	...
	$("#reject").click(function(){
		...
		$("#action").val("deposit_invoice_leader_reject");
		$("#formID").submit();
	});
});
</script>
