...
<div id="main">
	...
	<div id="content" class="fix">
        ...
        <li><a href="[BASE_URL]finance/deposit/?o=deposit_invoice_import">开票信息导入</a></li>
		        ...
		        <li><a href="[BASE_URL]finance/deposit/?o=deposit_receivables">保证金收款编辑</a></li>
		        <li class="on"><a>保证金收款信息查询</a></li>
        ...
        <div class="listform fix">
            ...
            <table class="etable" cellpadding="0" cellspacing="0" border="0" id="ilist">
		        ...
		        <tr>
		          ...
		          <th style="width:150px">收款日期</th>
		          <th>执行单号</th>
		          <th>客户名称</th>
		          <th style="width:230px;">收款金额</th>
		          <th>付款人名称</th>
		          <th>登记人</th>
		          <th>状态</th>
		        </tr>
      		...
      		<table>
      			<tr>
      			<td><input type="hidden" name="vcode" id="vcode" value="[VCODE]"/><input type="hidden" name="action" value="deposit_receivables_export"/>
      			</td>
      			</tr>
      		</table>
      		</form>
...
$(document).ready(function() {
	...
	$("#dosearch").click(function(){
		location.href = base_url + "finance/deposit/?o=deposit_receivables_search&starttime=" + $("#starttime").val() + "&endtime=" + $("#endtime").val() + "&search=" + $("#search").val();
	});
	//全选
