...
<div id="main">
	...
	<div id="content" class="fix">
		...
		<div class="tab" id="tab" style="height:30px">
        	<ul>
        		<li><a  href="[BASE_URL]finance/?o=setting_rebate">返点比例设置</a></li>
        		<li><a href="[BASE_URL]finance/?o=rebate_list">返点比例列表</a></li>
        		<li class="on"><a>返点比例导出</a></li>
      		</ul>
		</div>
       <div class="publicform fix">
			<form id="formID" method="post" action="[BASE_URL]finance/action.php" target="post_frame">
            <div class="btn_div"><input type="hidden" name="vcode" id="vcode" value="[VCODE]"/><input type="hidden" name="action" value="reabte_rate_export"/><input type="submit" value="导出" class="btn_sub" id="sub" /></div>
            </form>
