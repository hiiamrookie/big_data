...
<div id="main">
	...
	<div id="content" class="fix">
		...
		<div class="tab">
      		<ul>
        		<li><a href="[BASE_URL]finance/payment/?o=payment_deposit_userinput&id=[ASSIGNID]">分配执行单</a></li>
        		<li class="on"><a>已分配记录</a></li>
        		<li><a href="[BASE_URL]finance/payment/?o=media_apply_deposit_user_assignlist">待输入批量付合同款列表</a></li>
      		</ul>
    	</div>
...
$(document).ready(function() {	
	$("#itemdg").datagrid({
		...
		striped:true,
		rownumbers:true,
		url:base_url + "get_data.php?action=getMediaDepositPaymentItems&apply_id=[ID]",
		columns:
			[[
	...
	$("#dg").datagrid({
		...
		rownumbers:true,
		toolbar:'#toolbar',
		url:base_url + "get_data.php?action=getMediaDepositPaymentAssignedPid&apply_id=[ID]",
		columns:
			[[
