...
$(document).ready(function() {
	$("#paymentdg").datagrid({
		url:base_url + "get_data.php?action=getMediaPaymentGD&apply_id=" + encodeURI($("#id").val()),
		height:"auto",
		title:"已付款记录",
		autoRowHeight:true,
		striped:true,
