...
<div id="main">
	...
	<div id="content" class="fix">
		...
		<div class="tab">
      		<ul>
        		<li class="on"><a>归档个人付款申请</a></li>
        		<li><a href="[BASE_URL]finance/payment/?o=person_apply_manager">个人付款申请列表</a></li>
      		</ul>
    	</div>
    	<div class="publicform fix">
			...
			<table  id="paymentdg"></table>
				...
				<table width="100%" cellpadding="0" cellspacing="0" border="0" class="sbd1">
					...
					<tr><td style="font-weight:bold; width:150px">付款金额</td><td><input type="text" name="paymentamount"  style="height:20px;"/></td></tr>
      		...
      		<div class="btn_div">
        		<input type="hidden" name="deposit_deductiuon" id="deposit_deductiuon" value="[DEPOSITDEDUCTION]"/><input type="hidden" name="id" id="id" value="[APPLYID]"/><input type="hidden" name="gdvalues" id="gdvalues"/><input type="hidden" name="vcode" id="vcode" value="[VCODE]"/><input type="hidden" name="action" id="action" value="payment_person_gd"/><input type="button" value="提交" class="btn_sub" id="submitb" name="subbtn"/>
      		</div>
      		</form>
...
$(document).ready(function() {
	...
	$("#paymentdg").datagrid({
		url:base_url + "get_data.php?action=getPersonPaymentGD&apply_id=" + encodeURI($("#id").val()),
		height:"auto",
		title:"已付款记录",
		autoRowHeight:true,
		striped:true,
	...
	*/
	...
	$.ajax({
		   ...
		   cache:"false",
		   data: "action=get_payment_person_apply_pidinfo&id=[APPLYID]&t=" + Math.random() + "&vcode=" + vcode,
		   dataType:'text',
		   async: false,
