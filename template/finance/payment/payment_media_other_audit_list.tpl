...
$(document).ready(function() {
	$("#assigndg").datagrid({
		url:base_url + "get_data.php?action=getMediaPaymentAssignInfos&apply_id=" + $("#id").val(),
		title:"分配情况",
		autoRowHeight:true,
		striped:true,
		rownumbers:true,
...
function showItems(apply_id,uid){
	location.href=base_url + "finance/payment/?o=audituserassigned&id=" + apply_id + "&uid=" + uid;
}
</script>
</body>
</html>
