...
<div id="main">
	...
	<div id="content" class="fix">
		...
		<div class="tab">
      		<ul>
        		<li class="on"><a>申请媒体付款</a></li>
        		<li><a href="[BASE_URL]finance/payment/?o=mymedialist">已申请媒体付款列表</a></li>
        		<li><a href="[BASE_URL]finance/payment/?o=media_deposit_apply">申请媒体保证金付款</a></li>
    	...
    	<div class="publicform fix">
    		<form id="formID" method="post" action="[BASE_URL]finance/action.php" target="post_frame">
          		...
          		<tr>
          			...
          			<td>
          				<div>
                    		...
                    		<input type="button" id="upload" value="上 传" onclick="up_uploadfile(this,'rebate_dids',0);" class="btn"/><input type="hidden" name="rebate_dids" id="rebate_dids" size="50" value="^"/>&nbsp;&nbsp;<font color="red">*只能上传 [VALIDATE_TYPE] 类型的文件，且单个文件最多 [VALIDATE_SIZE]M</font>
						</div>
					</td>
        		</tr>
        		<tr>
      		...
      		<div class="btn_div">
        		<input type="hidden" name="vcode" id="vcode" value="[VCODE]"/><input type="hidden" name="action" value="payment_media_apply"/><input type="button" value="提 交" class="btn_sub" id="sub" name="sub"/>
      		</div>
      		</form>
