    		...
    		<form id="formID" method="post" action="[BASE_URL]finance/action.php" target="post_frame">
      		<table width="100%" cellpadding="0" cellspacing="0" border="0" class="sbd1">
          		...
          		<tr>
          			...
          			<td>
          				<div>
                    		...
                    		<input type="button" id="upload" value="上 传" onclick="up_uploadfile(this,'rebate_dids',0);" class="btn"/><input type="hidden" name="rebate_dids" id="rebate_dids" size="50" value="[REBATEDIDSVALUE]"/>&nbsp;&nbsp;<font color="red">*只能上传 [VALIDATE_TYPE] 类型的文件，且单个文件最多 [VALIDATE_SIZE]M</font>
						</div>
						 [REBATEDIDS]
					</td>
        		</tr>
        		<tr>
          			...
          			<td><input type="checkbox" name="is_deposit_deduction" value="1" [ISDEPOSITDEDUCTION]/>&nbsp;是</td>
          		</tr>
          		<tr>
      		...
      		<div class="btn_div">
        		<input type="hidden" name="statement_del" id="statement_del"/><input type="hidden" name="id" value="[ID]"/><input type="hidden" name="vcode" id="vcode" value="[VCODE]"/><input type="hidden" name="action" value="payment_media_edit"/><input type="button" value="提 交" class="btn_sub" id="sub" name="sub"/>
      		</div>
      		</form>
