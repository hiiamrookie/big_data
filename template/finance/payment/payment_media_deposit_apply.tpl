...
<div id="main">
	...
	<div id="content" class="fix">
		...
		<div class="tab">
      		<ul>
        		<li><a  href="[BASE_URL]finance/payment/?o=media_apply">申请媒体付款</a></li>
        		<li><a href="[BASE_URL]finance/payment/?o=mymedialist">已申请媒体付款列表</a></li>
        		<li class="on"><a>申请媒体保证金付款</a></li>
    	...
    	<div class="publicform fix">
    		<form id="formID" method="post" action="[BASE_URL]finance/action.php" target="post_frame">
      		<table width="100%" cellpadding="0" cellspacing="0" border="0" class="sbd1">
        		...
        		<tr>
      			...
      			<tr>
          			...
          			<td>
          				<input type="text" class="validate[required]" style="height:20px;" id="payment_amount_plan" name="payment_amount_plan" onblur="javascript:countpaymentreal();"/> 元
          			</td>
       	 		</tr>
      			<tr>
        		...
        		<tr>
          			...
          			<td><input type="checkbox" name="is_rebate_deduction" id="is_rebate_deduction" value="1" onclick="javascript:countAgain(this);"/>&nbsp;是</td>
          		</tr>
          		<tr>
          			<td style="font-weight:bold;width:150px">返点金额</td>
          			<td><input type="text" name="rebate_amount" id="rebate_amount" style="height:20px;" class="validate[optional,custom[money]]" onblur="javascript:countpaymentreal();"/> 元</td>
          		</tr>
          		<tr>
          			...
          			<td>
          				<div>
                    		...
                    		<input type="button" id="upload" value="上 传" onclick="up_uploadfile(this,'rebate_dids',0,0);" class="btn"/><input type="hidden" name="rebate_dids" id="rebate_dids" size="50" value="^"/>&nbsp;&nbsp;<font color="red">*只能上传 [VALIDATE_TYPE] 类型的文件，且单个文件最多 [VALIDATE_SIZE]M</font>
						</div>
					</td>
        		</tr>
        		<tr>
          			<td style="font-weight:bold;width:150px">保证金抵扣</td>
          			<td><input type="checkbox" name="is_deposit_deduction" id="is_deposit_deduction" value="1"/>&nbsp;是</td>
          		</tr>
          		<tr>
          			...
          			<td>
						<div>
                    		...
                    		<input type="button" id="upload2" value="上 传" onclick="up_uploadfile(this,'deposit_dids',0,0);" class="btn"/><input type="hidden" name="deposit_dids" id="deposit_dids" size="50" value="^"/>&nbsp;&nbsp;<font color="red">*只能上传 [VALIDATE_TYPE] 类型的文件，且单个文件最多 [VALIDATE_SIZE]M</font>
						</div>
					</td>
        		</tr>
        		<tr>
          			<td style="font-weight:bold;width:150px">个人借款抵扣</td>
          			<td><input type="checkbox" name="is_person_loan_deduction" id="is_person_loan_deduction" value="1" onclick="javascript:countAgain(this);"/>&nbsp;是</td>
        		</tr>
        		<tr>
        			<td style="font-weight:bold;width:150px">个人借款金额</td>
        			<td><input type="text" name="person_loan_amount" id="person_loan_amount" style="height:20px;" class="validate[optional,custom[money]]" onblur="javascript:countpaymentreal();"/> 元</td>
        		</tr>
        		<tr>
        		...
        		<tr>
       	 		...
       	 		<tr>
          			...
          			<td><input type="text" id="payment_apply_deadline" name="payment_apply_deadline" onclick="WdatePicker({minDate:'%y-%M-%d'});" class="validate[required] text Wdate" readonly="readonly"/></td>
        		</tr>
        		<tr>
          			...
          			<td>
						<div>
                    		...
                    		<input type="button" id="upload3" value="上 传" onclick="up_uploadfile(this,'statement',1,1);" class="btn"/>&nbsp;&nbsp;<input type="button" value="&nbsp;下载模板&nbsp;" id="dt" class="longbtn"/><input type="hidden" name="statement" id="statement" size="50"/>&nbsp;&nbsp;<font color="red">*只能上传 [VALIDATE_EXCEL_TYPE] 类型的文件，且单个文件最多 [VALIDATE_SIZE]M</font>
						</div>
					</td>
				</tr>
				<tr>
        		...
        		<tr>
        			<td style="font-weight:bold;width:50px;">选择以下用户分配执行单<input type="hidden" value="," name="users" id="users"/></td>
        			<td id="userlist"></td>
        		</tr>
        		<tr>
      		...
      		<div class="btn_div">
        		<input type="hidden" name="vcode" id="vcode" value="[VCODE]"/><input type="hidden" name="action" value="payment_media_deposit_apply"/><input type="button" value="提 交" class="btn_sub" id="sub" name="sub"/>
      		</div>
      		</form>
