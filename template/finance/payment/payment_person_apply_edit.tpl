...
<div id="main">
	...
	<div id="content" class="fix">
		...
		<div class="tab">
      		<ul>
        		<li class="on"><a>[EDITTYPE]</a></li>
        		<li><a href="[BASE_URL]finance/payment/?o=payment_apply_mylist">申请付合同款列表</a></li>
      		</ul>
    	</div>
    		...
    		<form id="formID" method="post" action="[BASE_URL]finance/action.php" target="post_frame">
      		<table width="100%" cellpadding="0" cellspacing="0" border="0" class="sbd1">
        		...
        		<tr>
          			...
          			<td>
          			<b><span style="color:#ff9933; font-size:14px" id="ra">[REBATEAMOUNT]</span></b>
        		...
        		<tr>
          			...
          			<td><input style="height:20px;" type="text" name="rebate_rate" id="rebate_rate" size="6" value="[REBATERATE]"/>&nbsp;%</td>
        		</tr>
        		<tr>
        		...
        		<tr>
          			...
          			<td>
          			<b><span style="color:#ff9933; font-size:14px" id="plaa">[PERSONLOANAMOUNT]</span></b>
          			<input type="hidden" name="person_loan_amount" id="person_loan_amount"  value="[PERSONLOANAMOUNT]" style="height:20px;"/> 元</td>
        		</tr>
        		<tr>
...
$(document).ready(function() {	
	...
	$("#selectdeposit").datagrid({
		...
		toolbar: '#tb2',
	    striped : true,
	    url : base_url + 'get_data.php?action=getDepositDeduction&apply_id=' + $("#id").val() + "&deposit_deductiuon=" + $("#deposit_deductiuon").val() + "&payment_type=1",
	    columns:[[
	...
	*/
	...
	$.ajax({
		   ...
		   cache:"false",
		   data: "action=get_payment_person_apply_pidinfo_search&pids=" + $("#pids").val() + "&type=" + $("#action").val() + "&apply_id=" + $("#id").val() + "&t=" + Math.random() + "&vcode=" + vcode,
		   dataType:'text',
		   async: false,
		   success: function(msg){
			   rows = $.parseJSON(msg);
