       ...
       <div class="publicform fix">
			...
			<table class="sbd1" width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    ...
                    <td><select class="easyui-combobox" name="media_short" id="media_short" style="width:200px;">
							[SUPPLIERSHORTNAMES]
						</select></td>
                </tr>
                <tr>
                    ...
                    <td>
                    	...
                    	<select id="categorytype" name="categorytype" class="select" style="width:200px;"/>[CATEGORIES]</select>
                    </td>
                </tr>
                 <tr>
                    <td style="font-weight:bold" width="150">客户行业分类</td>
	                <td>
	               		<select id="industrytype" name="industrytype" class="select" style="width:200px;">[INDUSTRIES]</select>
	               </td>
                </tr>
                 <tr>
                    <td style="font-weight:bold" width="150">返点比例</td>
                    <td><input type="text" name="rebate"  id="rebate" class="validate[required,custom[number],min[0],max[100]] text_new" style="width: 40px;" value="[REBATE]"/>&nbsp;%</td>
                </tr>
            </table>
            <div class="btn_div"><input type="hidden" name="vcode" id="vcode" value="[VCODE]"/><input type="hidden" name="id" value="[ID]"/><input type="hidden" name="action" value="update_rebate"/><input type="submit" value="确定" class="btn_sub" id="sub" /></div>
            </form>
	...
	$("#supplier_name").combobox({
		onSelect:function(newValue,oldValue){
			$.ajax({
				   ...
				   url: "do.php",
				   cache:false,
				   data: "action=get_category_industry_by_supplierid&sid=" + $('#supplier_name').combobox('getValue') + "&t=" + Math.random() + "&vcode=" + vcode,
				   dataType:'text',
				   async: false,
