	...
	<div id="content" class="fix">
    	...
    	<div class="tab">
      		<ul>
        		...
        		<li><a href="?o=invoicelist">待审核开票列表</a></li>
      		</ul>
    	</div>
    	<div class="publicform fix">
    		<form id="formID" method="post" action="[BASE_URL]finance/action.php" target="post_frame">
      		...
      		<div>
      			<input type="hidden" name="vcode" id="vcode" value="[VCODE]"/><input type="hidden" name="action" id="action" value="invoice_print"/>
      		</div>
      		</form>
...
$(document).ready(function() {	
	...
	$("#confirm1").click(function(){
		...
		$("#action").val("invoice_print");
		window.open(base_url + "finance/invoice/?o=print&id=" + $("#invoiceid").val());
		$("#formID").submit();
	});
