    		...
    		<form id="formID" method="post" action="[BASE_URL]finance/action.php" target="post_frame">
      		<table width="100%" cellpadding="0" cellspacing="0" border="0" class="sbd1">
       			<tr>
          			...
          			<td>
            			<input type="text" class="text" style="width:300px" id="search" name="search"/>
        		...
        		<tr>
          			...
          			<td>
            			...
            			<div id="showzp" style="display:none">
            				<br />
            				<div>纳税人识别号：&nbsp;<input type="text" class="text" style="width:350px" id="d1" name="d1" value="[D1]"/></div>
                			<div>地址、电话：&nbsp;&nbsp;&nbsp;<input type="text" class="text" style="width:350px" id="d2" name="d2" value="[D2]"/></div>
                			<div>开户行及账号：&nbsp;<input type="text" class="text" style="width:350px" id="d3" name="d3" value="[D3]"/></div>
            			</div>
          			</td>
       	 		</tr>
        		<tr>
          			<td style="font-weight:bold">开票抬头</td>
          			<td><input type="text" class="validate[required,maxSize[200]] text" style="width:300px" id="title" name="title" value="[TITLE]"/></td>
        		</tr>
        		<tr>
          			<td style="font-weight:bold">开票内容</td>
          			<td><input type="text" class="validate[required,maxSize[200]] text" style="width:300px" id="cont" name="cont" value="[CONTENT]"/></td>
        		</tr>
		        <tr>
      		...
      		<div class="btn_div">
        		<input type="hidden" name="invoiceid" id="invoiceid" value="[ID]"/><input type="hidden" name="vcode" id="vcode" value="[VCODE]"/><input type="hidden" name="action" value="invoice_myupdate"/><input type="hidden" name="pids" id="pids" value="[PIDS]"/><input type="submit" value="提 交" class="btn_sub" id="submit" />
      		</div>
      		</form>
