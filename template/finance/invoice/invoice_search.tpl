	...
	<div id="content" class="fix">
        ...
        <div class="listform fix">
            ...
            <table class="etable" cellpadding="0" cellspacing="0" border="0" id="ilist">
      		...
      		<table>
      			<tr>
      			<td><input type="hidden" name="vcode" id="vcode" value="[VCODE]"/><input type="hidden" name="action" value="invoice_export"/>
      			</td>
      			</tr>
      		</table>
      		</form>
...
$(document).ready(function() {
	...
	$("#dosearch").click(function(){
		location.href = base_url + "finance/invoice/?o=invoice_search&starttime=" + $("#starttime").val() + "&endtime=" + $("#endtime").val() + "&search=" + $("#search").val();
	});
	//全选
