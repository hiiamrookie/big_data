	...
	<div id="content" class="fix">
        ...
        <div class="listform fix">
            ...
            <table class="etable" cellpadding="0" cellspacing="0" border="0" id="ilist">
		      	<thead>
		        <tr>
		          <th style="width:20px"><input type="checkbox" id="selectall"/> 全选</th>
		          <th style="width:150px">申请时间</th>
		          <th style="width:200px">开票抬头</th>
		          <th style="width:200px">开票备注</th>
		          <th>开票金额</th>
		          <th>开票类型</th>
		          <th>所属公司</th>
		          <th>申请人</th>
      		...
      		<table>
      			<tr>
      			<td><input type="hidden" name="vcode" id="vcode" value="[VCODE]"/><input type="hidden" name="action" value="invoice_normal_export"/>
      			</td>
      			</tr>
      		</table>
      		</form>
...
$(document).ready(function() {
	...
	$("#dosearch").click(function(){
		location.href = base_url + "finance/invoice/?o=insearch&starttime=" + $("#starttime").val() + "&endtime=" + $("#endtime").val() + "&search=" + $("#search").val();
	});
	//全选
