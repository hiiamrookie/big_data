                ...
                <tr>
                    <td >
                        ...
                        <input type="file" name="upfile" id="upfile" class="validate[required]"/>
                         &nbsp;&nbsp;<input type="submit" value="上 传" class="btn"/>&nbsp;&nbsp;<input type="button" value="&nbsp;下载模板&nbsp;" id="dt" class="longbtn"/>&nbsp;&nbsp;<font color="red">*只能上传 [VALIDATEFILE] 类型的文件，且单个文件最多 [MAXFILESIZE]M</font><input type="hidden" name="vcode" id="vcode" value="[VCODE]"/><input type="hidden" name="action" value="receivables_import"/>
                    </td>
                </tr>
            </table>
      		</form>
...
$(document).ready(function() {
	...
	$("#dt").click(function(){
		location.href= base_url + "download_template.php?type=receivables";
	});
});
</script>
</body>
