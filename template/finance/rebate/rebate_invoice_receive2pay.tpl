    	...
    	<form id="formID" method="post" action="[BASE_URL]finance/action.php" target="post_frame">
      	...
      	<p/>
      	 <table width="100%" cellpadding="0" cellspacing="0" border="0" class="sbd1"> 
      	 	<tr>
      	 		<td colspan="7">关联付款申请</td>
      	 	</tr>
      	 	<tr>
      	 		<td style="font-weight:bold;width:150px">执行单号</td><td><input type="text" name="searchpid" id="searchpid" style="height:20px;"/></td>
      	 		<td style="font-weight:bold;width:150px">客户名称</td><td><input type="text" name="searchcusname" id="searchcusname" style="height:20px;"/></td>
      	 		<td style="font-weight:bold;width:150px">媒体名称</td><td colspan="2"><input type="text" name="searchmedianame" id="searchmedianame" style="height:20px;"/></td>
      	 	</tr>
      	 	<tr>
      	 ...
      	 <p/>
      	  ...
      	  <p/>
      	  <div class="btn_div">
        		<input type="hidden" name="id" id="id" value="[ID]"/><input type="hidden" name="vcode" id="vcode" value="[VCODE]"/><input type="hidden" name="action" value="rebate_invoice_receive2pay"/><input type="hidden" name="pids" id="pids"/><input type="submit" value="提 交" class="btn_sub" id="submit" />
      		</div>
      	  </form>
