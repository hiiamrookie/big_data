	...
	<div id="content" class="fix">
		...
		<div class="tab" id="tab" style="height:30px">
        	<ul>
        		...
        		<li><a href="[BASE_URL]finance/refund/?o=mediarefund">新增媒体退款记录</a></li>
        		<li class="on"><a>媒体退款列表</a></li>
      		</ul>
		</div>
...
function cancel(id){
	if(window.confirm("确认撤消该媒体退款记录？")){
		$.ajax({
			   type: "POST",
			   url: base_url + "finance/refund/do.php",
			   cache:false,
			   data: "action=cancel_media_refund&id=" + id + "&t=" + Math.random() + "&vcode=" + vcode,
			   dataType:'text',
			   async: false,
