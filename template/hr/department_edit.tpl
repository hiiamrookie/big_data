		...
		<div class="publicform fix">
        	...
        	<table width="100%" cellpadding="0" cellspacing="0" border="0" class="sbd1">
                ...
                <tr>
                    ...
                    <td><input class="validate[required,maxSize[50]]" type="text" style="width:200px;height:20px;" id="name" name="name" value="[NAME]" /> </td>
                </tr>
                <tr>
                    <td style="width:150px;">是否支持部门：</td>
                    <td>
                    	<input type="radio" name="issupport" value="0" [S1] /> 否
                        <input type="radio" name="issupport" value="1" [S2] /> 是
                    </td>
                </tr>
			</table>
			<div class="btn_div">
				<input type="hidden" name="dep_id" value="[DEPID]"/><input type="hidden" name="vcode" id="vcode" value="[VCODE]"/><input type="hidden" name="action" value="dep_update"/><input type="submit" value="提 交" class="btn_sub" id="submit" />
			</div>
			</form>
