		...
		<div class="publicform fix">
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0" class="sbd1">
                <tr>
                    ...
                    <td><input type="text" class="validate[optional,max[100]] text ac_input" style="width:300px;" id="pid" name="pid" value="[PID]"/>
                    </td>
                </tr>
                <tr>
                    <td style="font-weight:bold">项目名称</td>
                    <td id="td1"><input type="text" class="validate[required,maxSize[200]] text ac_input" style="width:300px;" id="project_name" name="project_name" value="[PROJECTNAME]"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><textarea style="width:400px;height:80px" id="cycle" class="validate[required,maxSize[1000]] textarea" rows="3" name="cycle">[CYCLE]</textarea>
                    </td>
                </tr>
                <tr>
                    <td style="font-weight:bold">网站流量预估</td>
                    <td><textarea style="width:400px;height:80px" id="traffic" class="validate[optional,maxSize[1000]] textarea" rows="3" name="traffic">[TRAFFIC]</textarea>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                    	<div>
                    		...
                    		<input type="button" id="upload" value="上传" onclick="up_uploadfile(this,'dids',0,0);" class="btn"/><input type="hidden" name="dids" id="dids" value="[DIDSVALUE]"/>&nbsp;&nbsp;<font color="red">*只能上传 [VALIDATE_TYPE] 类型的文件，且单个文件最多 [VALIDATE_SIZE]M</font>
						</div>
						[DIDS]
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                    	<textarea style="width:400px;height:80px" id="project_background" class="validate[required,maxSize[1000]] textarea" rows="3" name="project_background">[PROJECTBACKGROUND]</textarea>
                    </td>
                </tr>
                <tr>
			...
			<div class="btn_div"><input type="hidden" name="tpid" value="[TPID]"/><input type="hidden" name="project_id" value="[PROJECTID]"/><input type="hidden" name="vcode" value="[VCODE]"/><input type="hidden" name="action" value="project_edit"/><input type="submit" value="提 交" class="btn_sub" id="submit" />
			</div>
			</form>
