...
<div id="main">
	...
	<div id="content" class="fix">
		...
		<div class="tab" id="tab"  style="height:30px">
        	<ul>
				<li><a href="[BASE_URL]tec/?o=projectadd">新建项目需求</a></li>
				<li class="on"><a>项目需求列表</a></li>
			</ul>
		</div>
...
<script type="text/javascript" src="[BASE_URL]tec/tec.js" language="javascript"></script>
