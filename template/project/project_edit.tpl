		...
		<div class="publicform fix">
			...
			<table class="sbd1" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    ...
                    <td><input type="text" name="projectname" id="projectname" style="width:200px;" class="validate[required,maxSize[200]] text_new" value="[PROJECTNAME]"/></td>
                </tr>
                <tr>
            ...
            <div class="btn_div"><input type="hidden" name="vcode" id="vcode" value="[VCODE]"/><input type="hidden" name="id" value="[ID]"/><input type="hidden" name="action" value="project_update"/><input type="submit" value="提 交" class="btn_sub" id="submit" /></div>
            </form>
