        ...
        <div class="box">
            <div class="publicform fix">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="sbd1">
                	<tr bgcolor="#FCBAA7">
                        <td style="font-weight:bold" colspan="2">驳回理由：</td>
                        <td>[MSG]</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="projectname" id="projectname" style="width:300px" class="validate[required,maxSize[200]] text_new" value="[NAME]" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="principal" id="principal" class="validate[required] select">
                                [PRINCIPAL]
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <!--select name="actorlist" id="actorlist" class="validate[required,funcCall[check_actor]] select"-->
                             <select name="actorlist" id="actorlist" class="select">
                                [ACTORLIST]
                            </select>
                            已选人员：<input type="text" style="width:300px;" class="validate[required] text_new" name="actor" id="actor" value="[ACTOR]"/>
                            <!--input type="hidden" style="width:300px;" class="text ac_input" name="actor" id="actor" value="[ACTOR]"/-->
                        </td>
                    </tr>
                    <tr>
                        <td style="font-weight:bold" colspan="2">项目实际执行期：</td>
                        <td>开始：
                            <input type="text" onclick="checkdatetype();" style="width:100px" name="starttime" id="starttime" class="validate[required] text Wdate" value="[STARTTIME]" />
                            &nbsp;&nbsp;
                            结束：
                            <input type="text" onclick="WdatePicker({minDate:'#F{$dp.$D(\'starttime\')}'})" style="width:100px" name="endtime" id="endtime" class="validate[required] text Wdate" value="[ENDTIME]" /></td>
                    </tr>
                ...
                <div class="btn_div"><input type="hidden" name="vcode" value="[VCODE]"/><input type="hidden" name="action" value="executive_update"/><input type="submit" value="提 交" class="btn_sub" id="submit" /></div>
            	</form>
...
$(document).ready(function() {
	$("#is2agent").click(function(){
		if($(this).attr("checked")=="checked"){
			$("#agentcusname").addClass("validate[required,maxSize[255]]");
			$("#agentcusname").attr("readonly",false);
			$("#customertype").attr("disabled",false);
		}else{
			$("#agentcusname").removeClass("validate[required,maxSize[255]]");
			$("#agentcusname").val("");
			$("#customertype").val("");
			$("#agentcusname").attr("readonly",true);
	...
	$("#cyform").validationEngine("attach",{ 
		validationEventTrigger: "",
		autoHidePrompt:true,
		autoHideDelay:3000,
		success: false,
