...
<div id="main">
	...
	<div id="content" class="fix">
		<div class="crumbs">数据报表 - 利润</div>
		<div class="tab" id="tab" style="height:30px">
        	<ul>
                <li><a href="?o=data&search=[SEARCH]">执行成本明细</a></li>
                <li><a href="?o=rebate&search=[SEARCH]">应得返点</a></li>
                <li class="on"><a>利润</a></li>
			</ul>
		</div>       
...
function dosearch(){
  ...
  location.href=$.sprintf(base_url + "report/?o=profit&search=%s",searchcontent);
}

//  利润
    var chart1;
    var key_json = [key_json];
    var profit_append_data_json = [profit_append_data_json];
    AmCharts.ready(function () {
        // SERIAL CHART
        chart1 = new AmCharts.AmSerialChart();
        chart1.dataProvider = profit_append_data_json;
