	...
	<div id="content" class="fix">
		...
		<div class="publicform fix">
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="1" class="sbd1">
                <tr>
                    <td style="font-weight:bold;width:150px;">外包类型名称</td>
                    <td><input type="text" name="outsourcing_typename" id="outsourcing_typename" style="width:200px;" class="validate[required,maxSize[255]] text_new"/></td>
                </tr>
                <tr>
                	<td style="font-weight:bold">最大金额限制</td>
                	<td><input type="checkbox" name="is_max_amount" id="is_max_amount" value="1" checked/>&nbsp;无限制&nbsp;&nbsp;&nbsp;<input type="text" name="max_amount" id="max_amount" class="validate[optional,custom[money],min[0.01]] text_new" readonly/>&nbsp;元</td>
                </tr>
                <tr>
			...
			<div class="btn_div"><input type="hidden" name="vcode" value="[VCODE]"/><input type="hidden" name="action" value="add_outsoourcing_type"/><input type="submit" value="提 交" class="btn_sub" id="submit" />
			</div>
			</form>
