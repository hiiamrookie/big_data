...
<div id="main">
	...
	<div id="content" class="fix">
		...
		<div class="tab">
			<ul>
				<li class="on"><a>新建执行单外包审核流程</a></li>
		...
		<div class="publicform fix">
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0" class="sbd1">
                <tr>
                    ...
                    <td><input type="text" name="outsourcing_process_name" id="outsourcing_process_name" style="width:200px;" class="validate[required,maxSize[255]] text_new"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                    	<input type="button" value="添 加" class="btn" id="addprocesscontent"/><input type="hidden" name="contents" id="contents" value=","/><br/>
                        <div id="processcontentlist"></div>
                    </td>
                </tr>
			</table>
			<div class="btn_div"><input type="hidden" name="vcode" value="[VCODE]"/><input type="hidden" name="action" value="add_outsoourcing_process"/><input type="submit" value="提 交" class="btn_sub" id="submit" />
			</div>
			</form>
