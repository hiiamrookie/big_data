	...
	<div id="content" class="fix">
		...
		<div class="tab">
			<ul>
				...
				<li class="on"><a href="?=processadd">流程添加</a></li>
			</ul>
		</div>
		<div class="publicform fix">
			...
			<div class="btn_div"><input type="hidden" name="vcode" id="vcode" value="[VCODE]"><input type="hidden" name="action" value="process_add"><input type="submit" value="确 定" class="btn_sub" id="submit" /></div>
			</form>
