		...
		<div class="publicform fix">
        	...
        	<table width="100%" cellpadding="0" cellspacing="0" border="0" class="sbd1">
				<tr>
                    ...
                    <td><input type="text" class="validate[required,maxSize[100]]" style="width:200px;height:20px;" name="customer_name" id="customer_name" value="[CUSTOMERNAME]"/></td>
                </tr>
				<tr>
                	<td style="font-weight:bold" width="150">保险额度</td>
                    <td><input type="text" class="validate[required,custom[money]]" style="width:200px;height:20px;" name="safety" id="safety" value="[SAFETY]"/></td>
                </tr>
                 <tr>
                	<td style="font-weight:bold" width="150">临时保险额度</td>
                    <td><input type="text" class="validate[optional,custom[money]]" style="width:200px;height:20px;" name="tmpsafety" id="tmpsafety" value="[TMPSAFETY]"/></td>
                </tr>
                <tr>
                	<td style="font-weight:bold" width="150">临时保险额度截止日期</td>
                    <td><input type="text"  onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});" style="width:100px" id="tmpsafety_deadline" name="tmpsafety_deadline" class="text Wdate" readonly="readonly" value="[TMPSAFETYDEADLINE]"/></td>
                </tr>
			</table>
			<div class="btn_div"><input type="hidden" name="customer_id" id="customer_id" value="[CUSTOMERID]"/><input type="hidden" name="vcode" id="vcode" value="[VCODE]"/><input type="hidden" name="action" value="customer_update"/><input type="submit" value="修 改" class="btn_sub" id="submit" /></div>
			</form>
