...
<div id="main">
	...
	<div id="content" class="fix">
		...
		<div class="tab">
			<ul>
            	<li class="on"><a href="?o=depprocesslist">部门流程列表</a></li>
				<li><a href="?o=depprocessadd">部门流程添加</a></li>
			</ul>
		</div>
...
function del(id){
	if(window.confirm("确定要删除该流程吗？")){
		$.ajax({
			   ...
			   url: "do.php",
			   cache:"false",
			   data: "action=del_depprocess&id=" + id + "&t=" + Math.random() + "&vcode=" + vcode,
			   dataType:'text',
			   async: false,
		...
		location.href="[BASE_URL]manage/?o=depprocesslist";
	}
}
</script>
</body>
